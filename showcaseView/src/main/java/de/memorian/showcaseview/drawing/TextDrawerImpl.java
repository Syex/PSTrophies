...
public class TextDrawerImpl implements TextDrawer {
     ...
     */
    @Override
    public void calculateTextPosition(int canvasW, int canvasH, boolean hasNoTarget, ShowcaseView showcaseView) {
        ...
        // if the showcaseview has no target draw the text on the top
        if (hasNoTarget) {
            largest = 1;
        }
