...
package de.memorian.swipedismisslistviewtouchlistener;
...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
    ...
    public interface DismissCallbacks {
         ...
         */
        boolean canSwipe(int position, Direction direction);
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                Direction swipeDirection = swipeRight ? Direction.RIGHT : Direction.LEFT;
                boolean canSwipe = mCallbacks.canSwipe(mDownPosition, swipeDirection);
                if(canSwipe) {
    ...
    private void dismiss(final View view, final int position, final boolean dismissRight) {
        ...
        if (view == null) {
            ...
            Direction swipeDirection = dismissRight ? Direction.RIGHT : Direction.LEFT;
            mCallbacks.onDismiss(mListView, new int[]{position}, swipeDirection);
            return;
        }
